    ...
    public class HelpGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            if (isYoung)
            {
                ...
                this.AddHtml(110, 335, 450, 58, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at  " + (SupportWebsite == null ? "http://discord.16bitstudios.net" : SupportWebsite) + "), please use this option.", true, true);
            }
            else
            {
                ...
                this.AddHtml(110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at  " + (SupportWebsite == null ? "http://discord.16bitstudios.net" : SupportWebsite) + "), please use this option.", true, true);
            }
